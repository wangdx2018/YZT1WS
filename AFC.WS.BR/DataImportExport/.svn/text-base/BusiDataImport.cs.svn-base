...
{
    public class BusiDataImport:AbstractDataImport
    {
        ...
        public override int ImportSuccHandle()
        {
            ...
            byte type = Convert.ToByte(OperateType.BUSI_DATA_FILE);
            ...
            //todo:记录操作日志
            res = BuinessRule.GetInstace().logManager.AddLogInfo(OperationCode.busi_data_import, "0", "导入业务数据成功！");
            if (res != 0)
                return -1;
            return res;
        }

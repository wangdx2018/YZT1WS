...
{
    public class ParamDataImport:AbstractDataImport
    {
        ...
        public override int ImportSuccHandle()
        {
            ...
            byte type=Convert.ToByte(OperateType.PARA_DATA_FILE);
            ...
            //todo:记录操作日志
            res=BuinessRule.GetInstace().logManager.AddLogInfo(OperationCode.para_data_import, "0", "导入参数数据成功！");
            if (res != 0)
                return -2;
            return res;

...
{
    public class SoftwareDataImport:AbstractDataImport
    {
        ...
        public override FTPInfo GetFtpInfo()
        {
            ...
            ftpInfo.uploadPath = "runs/data/import/para_soft";
        ...
        public override List<string> GetNeedImportFiles(string indexFileName)
        {
            ...
            return paraHandle.ParseIndexFile(indexFileName);
        }
        ...
        public override int ImportSuccHandle()
        {
            ...
            byte type = Convert.ToByte(OperateType.SOFT_DATA_FILE);
            ...
            //todo:记录操作日志
            res = BuinessRule.GetInstace().logManager.AddLogInfo(OperationCode.soft_data_import, "0", "导入软件数据成功！");
            if (res != 0)
                return -1;
            return res;
        }

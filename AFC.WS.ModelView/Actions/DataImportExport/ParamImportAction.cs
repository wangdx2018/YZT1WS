...
{
    public class ParamImportAction:IAction
    {
        ParamDataImport paraImport = AbstractDataImport.CreateInstance(OperateType.PARA_DATA_FILE) as ParamDataImport;
        ...
        public ResultStatus DoAction(List<QueryCondition> actionParamsList)
        {
            ...
            switch (res)
            {
                ...
                case -3:
                    ...
                    return null;
                case -4:
                    MessageDialog.Show("上传参数文件失败！", "提示！", MessageBoxIcon.Information, MessageBoxButtons.Ok);
                    return null;
                case -5:
            ...
            /////上传索引文件
            //res = paraImport.UpLoadFile(usbOper.getFirstUSB() + "ParameterIndexFile.dat", "ParameterIndexFile.dat");
            //if (res != 0)
            //{
            //    MessageDialog.Show("上传索引文件失败！", "提示！", MessageBoxIcon.Information, MessageBoxButtons.Ok);
            //    return null;

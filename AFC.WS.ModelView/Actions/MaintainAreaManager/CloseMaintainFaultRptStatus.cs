...
namespace AFC.WS.ModelView.Actions.MaintainAreaManager
{
    ...
    public class CloseMaintainFaultRptStatus:  IAction
    {
        #region IAction 成员
        ...
        public bool CheckValid(List<QueryCondition> actionParamsList)
        {
            ...
            else if (maintenance_level.Equals("一般"))
            {maintenance_level="01"; }
            else if (maintenance_level.Equals("紧急"))
            { maintenance_level = "02"; }
            else if (maintenance_level.Equals("加急"))
            { maintenance_level = "03"; }

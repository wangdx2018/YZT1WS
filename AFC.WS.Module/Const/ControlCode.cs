...
namespace AFC.WS.Model.Const
{
    ...
    public class ControlCode
    {
        ...
        /// 正常服务
        /// </summary>
        public const ushort NORMAL_SERVICE = 0x0101;


        /// <summary>
        /// 暂停服务
        /// </summary>
        public const ushort PAUSE_SERVICE = 0x0201;

        /// <summary>
        /// 清空钱币
        /// </summary>
        public const ushort CLEAR_MONEY = 0x0301;

        /// <summary>
        /// 双向
        /// </summary>
        public const ushort AG_DOUBLE_WAY = 0x0400;

        /// <summary>
        /// 进站
        /// </summary>
        public const ushort AG_ENTER = 0x0401;

        /// <summary>
        /// 出站
        /// </summary>
        public const ushort AG_EXIT = 0x0402;

...
namespace AFC.WS.UI.DataSources
{
    ...
    public class AccessDataSource : IDataSource
    {
        ...
        public DataTable GetDataTable()
        {
            ...
            DBA dbo = new DBA(this.DBConnectionString);
            try
            {

                DataSet ds = dbo.ExecuteDataSetQuery(cmd);
        ...
        public DataTable FetchPagingData(int pageIndex, int pageSize)
        {
            ...
            try
            {
                ...
                DataSet ds = dbo.ExecuteDataSetQuery(finalCmd);
                if (ds != null&&ds.Tables.Count>0)
                    return null;
                return ds.Tables[0];
            }

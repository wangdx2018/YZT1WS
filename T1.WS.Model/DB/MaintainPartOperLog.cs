...
namespace T1.WS.Model.DB
{
    ...
    /// <summary>
    /// 数据库表名称：maintain_part_oper_log
    /// </summary>
    public class MaintainPartOperLog
    {
        ...
        /// <summary>
        /// COLUMN: DEV_PART_PHY_ID
        /// </summary>
        private string _dev_part_phy_id;
        ...
        /// COLUMN: DEV_PART_PHY_ID
        /// </summary>
        public string dev_part_phy_id
        {
            get
            {
                return this._dev_part_phy_id;
            }
            set
            {
                this._dev_part_phy_id = value;
            }
        }
